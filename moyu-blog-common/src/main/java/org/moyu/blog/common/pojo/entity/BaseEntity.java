...
public class BaseEntity implements Serializable {
  ...
  /** 引入雪花算法生成id */
  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "snowflake_generator")
  @GenericGenerator(
  ...
  public boolean equals(Object o) {
    ...
    return getId().equals(that.getId())
        && getCreateBy().equals(that.getCreateBy())
        && getUpdateBy().equals(that.getUpdateBy())
  ...
  public int hashCode() {
    return Objects.hash(
        getId(), getCreateBy(), getUpdateBy(), getCreateTime(), getUpdateTime(), isDeleted);
  }
